    ...
    <div className="bg-paper-50 min-h-screen">
      ...
      <div className="bg-white border-b border-paper-100">
        <div className="max-w-6xl mx-auto px-6 py-10">
          ...
          <h1 className="text-4xl font-black mb-2 text-ink-900">시행착오 리포트 작성</h1>
          <p className="text-paper-400 text-sm">5단계 구조화 템플릿에 따라 작성하세요. AI가 실시간으로 품질을 평가하고 가격을 추천합니다.</p>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="paper-card p-8 space-y-6">
              <h2 className="text-sm font-bold text-ink-800">기본 정보</h2>
              <div>
            ...
            <nav
              aria-label="작성 단계"
              className="flex gap-1.5 bg-paper-100 p-1.5 rounded-xl sticky top-20 z-20"
            >
              {STEPS.map((s, i) => {
                  ...
                  <button
                    ...
                    className={`flex-1 py-2 px-1 rounded-lg text-center transition-all ${
                      isCurrent
                        ...
                        : filled
                        ? 'text-gold-600 hover:bg-white/60'
                        : 'text-paper-400 hover:bg-white/40'
                    }`}
                  >
          ...
          <aside aria-label="AI 실시간 품질 평가" className="lg:col-span-4">
            <div className="paper-card p-8 sticky top-24">
              ...
              {/* 점수 + 등급 */}
              <div className="flex items-center justify-between mb-6 pb-6 border-b border-paper-100">
                <div>
                  <div className="text-6xl font-black tabular-nums text-ink-900 leading-none">
                    {evaluation.total}
                  </div>
              ...
              {/* 세부 점수 */}
              <div className="space-y-4 mb-6 pb-6 border-b border-paper-100">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-baseline">
                  ...
                  <span className="text-2xl font-black text-ink-900 tabular-nums">
              ...
              {evaluation.total < 60 && (
                <div role="alert" className="mt-5 p-4 bg-gold-50 border border-gold-200 rounded-xl text-xs text-ink-700 leading-relaxed">
